...
class WTIcons extends WTVMBaseType<Icons> with BaseTypeUtils {
  ...
  IconData door_back() {
    return Icons.door_back;
  }

  IconData door_back_sharp() {
    return Icons.door_back_sharp;
  }

  IconData door_back_rounded() {
    return Icons.door_back_rounded;
  }

  IconData door_back_outlined() {
    return Icons.door_back_outlined;
  }
  ...
  IconData door_front_sharp() {
    return Icons.door_front_sharp;
  }

  IconData door_front_rounded() {
    return Icons.door_front_rounded;
  }

  IconData door_front_outlined() {
    return Icons.door_front_outlined;
  }
  ...
  IconData six_ft_apart() {
    return Icons.six_ft_apart;
  }

  IconData six_ft_apart_sharp() {
    return Icons.six_ft_apart_sharp;
  }

  IconData six_ft_apart_rounded() {
    return Icons.six_ft_apart_rounded;
  }

  IconData six_ft_apart_outlined() {
